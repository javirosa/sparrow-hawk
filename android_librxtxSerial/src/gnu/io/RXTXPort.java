...
final public class RXTXPort extends SerialPort
{
	...
	*/
	...
	public native boolean changeIspeed(int ispeed) throws IOException;
	
	public native boolean changeOspeed(int ospeed) throws IOException;
...
/*------------------------  END OF CommAPI -----------------------------*/
	...
	private native static int nativeStaticGetBaudRate( String port )
		throws UnsupportedCommOperationException;
	private native static boolean nativeStaticSetBaudRate( String port, int baudrate )
	throws UnsupportedCommOperationException;
	...
	*
	*/
	public static boolean staticSetBaudRate( String port, int baudrate )
		throws UnsupportedCommOperationException
	{
		if ( debug )
			z.reportln( 
				"RXTXPort:staticSetBaudRate( " + port + ", " + baudrate + " )");
		return(nativeStaticSetBaudRate( port, baudrate ));
	}
